...
usage() {
  cat <<'EOF'
Usage:
  soft_vla/scripts/package_real_robot_deploy.sh [--with-smolvla] [--with-smolvla-extra] [--with-lerobot-videos] [--output PATH]

Build a small deployment tarball for the real soft-robot controller.

Default package:
  - soft_vla source/scripts/configs/docs/tests
