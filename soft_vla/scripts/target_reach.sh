/home/cao/miniconda3/envs/soft_vla_cuda/bin/python \
  ...
  --pressure-scale 1 \
  --delta-tcp-scale 1.0 \
  --log-jsonl /home/cao/skill_learning_soft_robot/soft_vla/tests/tmp/soft_vla_single_point.jsonl \
  --plot-path /home/cao/skill_learning_soft_robot/soft_vla/tests/tmp/soft_vla_single_point.png