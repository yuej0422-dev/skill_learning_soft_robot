...
#
# 推荐运行：
#   GAMEPAD_DEBUG_PRINT_ALL=1 bash soft_vla/scripts/real_robot/diagnostics/smolvla_human_intervention_debug.sh
...
args=(
  soft_vla/scripts/real_robot/diagnostics/deploy_smolvla_human_intervention_debug.py
