...
def train(args: argparse.Namespace) -> Path:
    ...
    train_dataset, train_stats = build_transition_dataset(
        episodes, train_episodes, state_mean, state_std, args.target_offset, args.reward_scale
    )
    val_dataset, val_stats = build_transition_dataset(
        episodes, val_episodes, state_mean, state_std, args.target_offset, args.reward_scale
    )
